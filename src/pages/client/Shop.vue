<!-- shop center -->
<template>
  <el-container class="Mall">
    <el-header>
      <div class="container clear">
        <span class="title" @click="navTo('/shop')">FOODSHOP 大家的杂货铺</span>
        <div class="right" v-if="clientName">
          <span class="name">欢迎您，{{clientName}}</span>
          <span @click="navTo('/shop/personal')">个人中心</span>
    ...
    <el-main class="content">
      ...
      <div class="fixedAd">
        <div @click="backToTop" v-show="shouldShowBT" >
    ...
    <el-footer>
      <div class="bottomInfo">
        <div class="container">
          ...
          <div class="intro footerItem">
            <p class="title">FOODSHOP</p>
            <p class="intro-p">欢迎光临本店，您的支持是我们最大的前进动力，本店所有产品均低价销售，并且保证质量，需要的亲请放心购买，我们一定会给您一个最舒心的购物体验</p>
            <div>
              关注我们：
      ...
      <div class="container">
        ...
        <div class="footerBottom">
          ...
          <p>XX公司版权所有 © 1996-2022   食品经营许可证：XXXXXXXXXXXXXXXXX</p>
        </div>
      </div>
    </el-footer>
  </el-container>
